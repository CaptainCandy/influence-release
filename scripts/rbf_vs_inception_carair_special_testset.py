# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 21:07:20 2019
...
np.savez('output21/%s_inception_features_new_train.npz' % dataset_name,
         inception_features_val=train_inception_features_val,
         labels=image_data_sets.train.labels)
np.savez('output21/%s_inception_features_new_test.npz' % dataset_name,
         inception_features_val=test_inception_features_val,
         labels=image_data_sets.test.labels)
...
for test_idx in  range(40):
    ...
    np.savez(
        'output21/adver_testset_carair_results_%s' % test_idx,
        test_idx=test_idx,
        distances=distances,
