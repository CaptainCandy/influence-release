# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 22:22:52 2019
...
def load_vehicles_adver_testset(num_train_ex_per_class=1000, 
    ...
    if os.path.exists(data_filename):
        ...
        f_adv = np.load(BASE_DIR + 'dataset_car-airplane_adversarial_testset_90per.npz')
        X_train = f['X_train']
        X_test = f_adv['X_test_adver']
        Y_train = f['Y_train']
        Y_test = f['Y_test']
