# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 20:58:10 2019
...
#%%
print('Save results...')
for test_idx in  [15, 18, 38, 41, 59, 91, 99, 103, 111, 116, 123, 143, 147, 165, 167, 168, 
    ...
    np.savez(
        'output16/adver_testset_carair_results_%s' % test_idx,
        test_idx=test_idx,
        distances=distances,
