# -*- coding: utf-8 -*-
"""
Created on Sun Apr 21 19:07:49 2019
...
def load_vehicles_dark_testset(num_train_ex_per_class=1000, 
    ...
    if os.path.exists(data_filename):
        ...
        f_dark = np.load(BASE_DIR + 'dataset_car-airplane_dark_testset.npz')
        X_train = f['X_train']
        X_test = f_dark['X_test']
        Y_train = f['Y_train']
        Y_test = f['Y_test']
