# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 20:55:35 2019
...
def load_vehicles_rainy_testset(num_train_ex_per_class=1000, 
    ...
    if os.path.exists(data_filename):
        ...
        f_rainy = np.load(BASE_DIR + 'dataset_car-airplane_rainy_testset.npz')
        X_train = f['X_train']
        X_test = f_rainy['X_test']
        Y_train = f['Y_train']
        Y_test = f['Y_test']
